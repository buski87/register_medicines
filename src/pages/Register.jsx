    ...
    <div className="h-screen flex items-center justify-center p-6 bg-white dark:bg-gray-800 dark:text-white">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 dark:text-white rounded shadow p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded mb-4 w-full">Registrar</button>
          <p className="mt-4 text-sm text-center">¿Ya tienes una cuenta? <Link to="/login" className="text-blue-500">Inicia sesión aquí</Link></p>
        </form>
      </div>
    </div>
  );
